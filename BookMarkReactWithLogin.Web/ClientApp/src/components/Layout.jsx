            ...
            <header>
                <nav className="navbar navbar-expand-sm navbar-dark fixed-top bg-dark border-bottom box-shadow">
                    <div className="container">
                        <a className="navbar-brand">BookMarkReactWithLogin</a>
                        ...
                        <div className="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                            <ul className="navbar-nav flex-grow-1">
                                ...
                                {!user && <>
                                    <li className="nav-item"><Link to="/signup" className='nav-link text-light'>Create Account</Link></li>
                                ...
                                {!!user && <>
                                    ...
                                    <li className="nav-item"><Link to="/addbookmark" className='nav-link text-light'>Add a Bookmark</Link></li>
